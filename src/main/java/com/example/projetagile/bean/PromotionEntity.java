...
public class PromotionEntity implements Serializable {
  ...
  public PromotionEntityPK getId() {
    return this.id;
  }

  public void setId(PromotionEntityPK id) {
    this.id = id;
  }
  ...
  public CandidatEntity addCandidat(CandidatEntity candidat) {
  ...
  public CandidatEntity removeCandidat(CandidatEntity candidat) {
